...
- [`ffpo_2d()`](https://pavel-hernadez-amaro.github.io/VDPO/reference/ffpo_2d.md)
  : Defining partially observed bidimensional functional data terms in
  VDPO formulae
...
- [`plot(`*`<po_2d_fit>`*`)`](https://pavel-hernadez-amaro.github.io/VDPO/reference/plot.po_2d_fit.md)
  : Plot method for partially observed bidimensional functional
  regression fits
- [`plot(`*`<po_fit>`*`)`](https://pavel-hernadez-amaro.github.io/VDPO/reference/plot.po_fit.md)
