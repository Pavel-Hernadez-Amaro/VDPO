...
2.  Optional smooth term if `use_f = TRUE`
3.  Optional non-functional linear covariate if `use_x = TRUE`
...
#> [1] -0.51884279  0.77455202
#> [3]  0.17400721  0.35218196
#> [5]  0.35125460 -0.08737818
dim(sim_data$X_s)       # Dimensions of functional covariate
#> [1] 100  99
head(sim_data$x1)       # Non-functional covariate (if use_x = TRUE)
#> [1] -1.51300593  0.23613533
#> [3]  0.46113917 -0.96449987
#> [5]  0.87276443 -0.03593889
```
...
![](includes/VDPO-01-unnamed-chunk-38-1.png)
...
![](includes/VDPO-01-unnamed-chunk-39-1.png)
